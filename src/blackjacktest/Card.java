...
public class Card{
    ...
    Card(int deckIndex, boolean face){
        ...
        if(deckIndex >= 0 && deckIndex <13){
            ...
            if(deckIndex >= 9){
                ...
                if(deckIndex == 0){
                    ...
                    rank = deckIndex + 1;
                    pip = Integer.toString(deckIndex + 1);
                }
            }   
        ...
        if(deckIndex > 12 && deckIndex <26){
            ...
            if(deckIndex >= 22){
                ...
                if(deckIndex == 13){
                    ...
                    rank = deckIndex - 12;
                    pip = Integer.toString(deckIndex - 12);
                }
            }   
            myGraphic = new StringBuilder(suit+pip);
        }
        if(deckIndex > 25 && deckIndex <39){
            ...
            if(deckIndex >= 35){
                ...
                if(deckIndex == 26){
                    ...
                    rank = deckIndex - 25;
                    pip = Integer.toString(deckIndex - 25);
        ...
        if(deckIndex > 38 && deckIndex <52){
            ...
            if(deckIndex >= 48){
                ...
                if(deckIndex == 39){
                    ...
                    rank = deckIndex - 38;
                    pip = Integer.toString(deckIndex - 38);
                }
            }   
            myGraphic = new StringBuilder(suit+pip);
        }
